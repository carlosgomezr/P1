...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      ++curPos;
      if ((i = jjnewStateCnt) == (startsAt = 473 - (jjnewStateCnt = startsAt)))
         return curPos;
      try { curChar = input_stream.readChar(); }
...
static final int[] jjnextStates = {
   131, 132, 133, 5, 7, 14, 15, 16, 17, 18, 19, 20, 21, 444, 462, 465, 
   472, 444, 447, 451, 459, 434, 442, 419, 428, 407, 410, 412, 358, 363, 370, 372, 
   378, 385, 391, 398, 401, 405, 296, 302, 310, 313, 320, 328, 335, 343, 347, 352, 
   262, 266, 273, 280, 282, 289, 223, 228, 236, 244, 247, 255, 201, 206, 215, 181, 
   187, 197, 170, 176, 158, 165, 143, 145, 149, 152, 126, 129, 8, 9, 10, 11, 
   12, 26, 28, 
};
...
static final long[] jjtoSkip = {
   0x3eL, 0x0L, 
    ...
    private final int[] jjrounds = new int[473];
    private final int[] jjstateSet = new int[2 * 473];
